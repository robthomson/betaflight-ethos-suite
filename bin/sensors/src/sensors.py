...
# Require config path from BFSUITE_CONFIG env var
CONFIG_PATH = os.environ.get('BFSUITE_CONFIG')

if not CONFIG_PATH:
    print("[CONFIG ERROR] Environment variable BFSUITE_CONFIG is not set.")
    sys.exit(1)
