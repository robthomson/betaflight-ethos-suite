...
local API_NAME = "BATTERY_STATE"
local MSP_API_CMD_READ = 130
local MSP_API_CMD_WRITE = nil
local MSP_REBUILD_ON_WRITE = false

-- LuaFormatter off
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "batteryCellCount", type = "U8", simResponse = {0}},
    {field = "batteryCapacity", type = "U16", simResponse = {0,0}},
    {field = "state", type = "U8", simResponse = {0}},
    {field = "mah", type = "U16", simResponse = {0,0}},
    {field = "amp", type = "U16", simResponse = {0,0}},
    {field = "alert", type = "U8", simResponse = {3}},
    {field = "voltage", type = "U16", simResponse = {2,0}},   
}
-- LuaFormatter on
