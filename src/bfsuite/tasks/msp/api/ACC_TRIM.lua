...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "pitch", type = "S16", simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = "@i18n(api.ACC_TRIM.pitch)@" },
    { field = "roll",  type = "S16", simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = "@i18n(api.ACC_TRIM.roll)@" },
}
-- LuaFormatter on
