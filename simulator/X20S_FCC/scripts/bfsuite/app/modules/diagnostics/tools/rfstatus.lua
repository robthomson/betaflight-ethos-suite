...
local function openPage(pidx, title, script)
    ...
    bfsuite.app.ui.fieldHeader("Diagnostics" .. " / " .. "Status")
    ...
    addStatusLine("CPU Load", string.format("%.1f%%", bfsuite.performance.cpuload or 0))

    addStatusLine("Memory free", string.format("%.1f kB", bfsuite.performance.freeram or 0))

    addStatusLine("Background Task", bfsuite.tasks.active() and "OK" or "ERROR")
