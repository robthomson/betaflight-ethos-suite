...
local S_PAGES = {{name = "Events", script = "audio_events.lua", image = "audio_events.png"}, {name = "Switches", script = "audio_switches.lua", image = "audio_switches.png"}, {name = "Timer", script = "audio_timer.lua", image = "audio_timer.png"}}
...
local function openPage(pidx, title, script)
    ...
    bfsuite.app.ui.fieldHeader("Settings" .. " / " .. "Audio")
