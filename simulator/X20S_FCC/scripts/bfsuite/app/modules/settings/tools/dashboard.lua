...
local S_PAGES = {[1] = {name = "Theme", script = "dashboard_theme.lua", image = "dashboard_theme.png"}, [2] = {name = "Settings", script = "dashboard_settings.lua", image = "dashboard_settings.png"}}
...
local function openPage(pidx, title, script)
    ...
    bfsuite.app.ui.fieldHeader("Settings" .. " / " .. "Dashboard")
