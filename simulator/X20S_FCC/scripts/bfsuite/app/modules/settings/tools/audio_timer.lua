...
local function openPage(pageIdx, title, script)
    ...
    bfsuite.app.ui.fieldHeader("Settings" .. " / " .. "Audio" .. " / " .. "Timer")
    ...
    bfsuite.app.formLines[bfsuite.app.formLineCnt] = form.addLine("Timer Alerting")
    ...
    formFieldCount = formFieldCount + 1
    bfsuite.app.formLineCnt = bfsuite.app.formLineCnt + 1
    bfsuite.app.formLines[bfsuite.app.formLineCnt] = form.addLine("Timer Elapsed Alert")
    ...
    bfsuite.app.formFields[formFieldCount] = form.addBooleanField(prePanel:addLine("Pre-timer Alert"), nil, function() return config.prealerton or false end, function(newValue)
    ...
    bfsuite.app.formFields[formFieldCount] = form.addChoiceField(prePanel:addLine("Alert Period"), nil, periodChoices, function() return config.prealertperiod or 30 end, function(newValue) config.prealertperiod = newValue end)
    ...
    bfsuite.app.formFields[formFieldCount] = form.addBooleanField(postPanel:addLine("Post-timer Alert"), nil, function() return config.postalerton or false end, function(newValue)
    ...
    bfsuite.app.formFields[formFieldCount] = form.addChoiceField(postPanel:addLine("Alert Period"), nil, periodChoices, function() return config.postalertperiod or 60 end, function(newValue) config.postalertperiod = newValue end)
    ...
    bfsuite.app.formFields[formFieldCount] = form.addChoiceField(postPanel:addLine("Alert Interval"), nil, intervalChoices, function() return config.postalertinterval or 10 end, function(newValue) config.postalertinterval = newValue end)
    bfsuite.app.formFields[formFieldCount]:enable((config.timeraudioenable or false) and (config.postalerton or false))
