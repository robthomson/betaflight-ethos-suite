...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "pitch", type = "S16", simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = "Use to trim if the heli drifts in one of the stabilized modes (angle, horizon, etc.)." },
    { field = "roll",  type = "S16", simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = "Use to trim if the heli drifts in one of the stabilized modes (angle, horizon, etc.)." },
}
-- LuaFormatter on
