...
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "rescue_mode", type = "U8", apiVersion = 1.46, simResponse = {1}, min = 0, max = 1, default = 0, table = {[0] = "OFF", "ON"}, help = "@i18n(api.RESCUE_PROFILE.help_rescue_mode)@"},
    {field = "rescue_flip_mode", type = "U8", apiVersion = 1.46, simResponse = {0}, min = 0, max = 1, default = 0, table = {[0] = "NO FLIP", "FLIP"}, help = "@i18n(api.RESCUE_PROFILE.help_rescue_flip_mode)@"},
