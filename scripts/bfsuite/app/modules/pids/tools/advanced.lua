...
local function onNavMenu()
    ...
    bfsuite.app.ui.openPage(pageIdx, "@i18n(app.modules.pids.name)@", "pids/pids.lua")
end

return {apidata = apidata, title = "@i18n(app.modules.pids.name)@", reboot = false, eepromWrite = true, refreshOnProfileChange = true, postLoad = postLoad, openPage = openPage, wakeup = wakeup, API = {}, onNavMenu = onNavMenu}