...
local function log(msg, lvl) if bfsuite and bfsuite.utils and bfsuite.utils.log then bfsuite.utils.log(msg, lvl or "debug") end end

local function maxTx() return bfsuite.tasks.msp.protocol.maxTxBufferSize end
local function maxRx() return bfsuite.tasks.msp.protocol.maxRxBufferSize end
