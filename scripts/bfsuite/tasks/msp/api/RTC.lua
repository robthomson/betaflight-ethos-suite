...
local function write()
    ...
    for _, field in ipairs(MSP_STRUCTURE_WRITE) do
        ...
        if field.type == "U32" then
            bfsuite.tasks.msp.mspHelper.writeU32(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "S32" then
            bfsuite.tasks.msp.mspHelper.writeU32(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "U24" then
            bfsuite.tasks.msp.mspHelper.writeU24(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "S24" then
            bfsuite.tasks.msp.mspHelper.writeU24(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "U16" then
            bfsuite.tasks.msp.mspHelper.writeU16(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "S16" then
            bfsuite.tasks.msp.mspHelper.writeU16(message.payload, payloadData[field.field], byteorder)
        elseif field.type == "U8" then
            bfsuite.tasks.msp.mspHelper.writeU8(message.payload, payloadData[field.field])
