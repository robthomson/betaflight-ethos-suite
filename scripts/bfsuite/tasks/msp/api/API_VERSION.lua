...
local MSP_API_SIMULATOR_RESPONSE = bfsuite.utils.splitVersionStringToNumbers(bfsuite.config.supportedMspApiVersion[bfsuite.preferences.developer.apiversion])
