...
local function read()
    local message = {
        ...
        processReply = function(self, buf)
            ...
            mspData = bfsuite.tasks.msp.api.parseMSPData(buf, MSP_API_STRUCTURE_READ)
        ...
        simulatorResponse = bfsuite.config.simulatorApiVersionResponse or MSP_API_SIMULATOR_RESPONSE,
        uuid = MSP_API_UUID,
