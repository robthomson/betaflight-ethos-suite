...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    { field = "thrMid8",                type = "U8",  apiVersion = 1.45 },
    { field = "thrExpo8",               type = "U8",  apiVersion = 1.45 },
    ...
    { field = "throttle_limit_type",    type = "U8",  apiVersion = 1.45 },
    { field = "throttle_limit_percent", type = "U8",  apiVersion = 1.45 },
    ...
    { field = "rates_type",             type = "U8",  apiVersion = 1.45 },
}
