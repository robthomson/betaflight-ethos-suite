...
- Throttle Sensors (throttle_percent)
 ...
 https://github.com/Betaflight/Betaflight-firmware/blob/c7cad2c86fd833fe4bce76728f4914602614058d/src/main/telemetry/sensors.h#L34C15-L34C24
]]

local sensorTable = {
    -- RSSI Sensors
    rssi = {
        name = bfsuite.i18n.get("telemetry.sensors.rssi"),
        mandatory = true,
        sim = {
    ...
    -- Arm Flags
    armflags = {
        name = bfsuite.i18n.get("telemetry.sensors.arming_flags"),
        mandatory = true,
        set_telemetry_sensors = 90,
        sim = {
            {uid=0x5001, unit=nil, dec=nil, value=function() return bfsuite.utils.simSensors('armflags') end, min = 0, max = 2},
        },
        sport = {
    ...
    -- Voltage Sensors
    voltage = {
        name = bfsuite.i18n.get("telemetry.sensors.voltage"),
        mandatory = true,
        set_telemetry_sensors = 3,
        sim =  {
            {uid=0x5002, unit=UNIT_VOLT, dec=2, value=function() return bfsuite.utils.simSensors('voltage') end, min = 0, max = 3000},
        },
        sport = {
    ...
    -- RPM Sensors
    rpm = {
        name = bfsuite.i18n.get("telemetry.sensors.headspeed"),
        mandatory = true,
        set_telemetry_sensors = 60,
        sim =  {
            {uid=0x5003, unit=UNIT_RPM, dec=nil, value=function() return bfsuite.utils.simSensors('rpm') end, min = 0, max = 2000},
        },
        sport = {
    ...
    -- Current Sensors
    current = {
        name = bfsuite.i18n.get("telemetry.sensors.current"),
        mandatory = false,
        set_telemetry_sensors = 18,
        sim =  {
            {uid=0x5004, unit=UNIT_AMPERE, dec=0, value=function() return bfsuite.utils.simSensors('current') end, min = 0, max = 25},
        },
        sport = {
    ...
    -- Temperature Sensors
    temp_esc = {
        name = bfsuite.i18n.get("telemetry.sensors.esc_temp"),
        mandatory = false,
        set_telemetry_sensors = 23,
        sim =  {
            {uid=0x5005, unit=UNIT_DEGREE, dec=0, value=function() return bfsuite.utils.simSensors('temp_esc') end, min = 0, max = 100},
        },   
        sport = {
    ...
    temp_mcu = {
        name = bfsuite.i18n.get("telemetry.sensors.mcu_temp"),
        mandatory = false,
        set_telemetry_sensors = 52,
        sim =  {
            {uid=0x5006, unit=UNIT_DEGREE, dec=0, value=function() return bfsuite.utils.simSensors('temp_mcu') end, min = 0, max = 100},
        },         
        sport = {
    ...
    fuel = {
        name = bfsuite.i18n.get("telemetry.sensors.fuel"),
        mandatory = false,
        set_telemetry_sensors = 6,
        sim =  {
            {uid=0x5007, unit=UNIT_PERCENT, dec=0, value=function() return bfsuite.utils.simSensors('fuel') end, min = 0, max = 100},
        },               
        sport = {
    ...
    consumption = {
        name = bfsuite.i18n.get("telemetry.sensors.consumption"),
        mandatory = true,
        set_telemetry_sensors = 5,
        sim =  {
            {uid=0x5008, unit=UNIT_MILLIAMPERE_HOUR, dec=0, value=function() return bfsuite.utils.simSensors('consumption') end, min = 0, max = 5000},
        },           
        sport = {
    ...
    -- Flight Mode Sensors
    governor = {
        name = bfsuite.i18n.get("telemetry.sensors.governor"),
        mandatory = true,
        set_telemetry_sensors = 93,
        sim =  {
            {uid=0x5009, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('governor') end, min = 0, max = 5},
        },        
        sport = {
    ...
    -- Adjustment Sensors
    adj_f = {
        name = bfsuite.i18n.get("telemetry.sensors.adj_func"),
        mandatory = true,
        set_telemetry_sensors = 99,
        sim =  {
            {uid=0x5010, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('adj_f') end, min = 0, max = 10},
        },           
        sport = {
    ...
    adj_v = {
        name = bfsuite.i18n.get("telemetry.sensors.adj_val"),
        mandatory = true,
        --set_telemetry_sensors = 99,  (we dont do this because its grouped with the adjf sensor)
        sim =  {
            {uid=0x5011, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('adj_v') end, min = 0, max = 2000},
        },           
        sport = {
    ...
    pid_profile = {
        name = bfsuite.i18n.get("telemetry.sensors.pid_profile"),
        mandatory = true,
        set_telemetry_sensors = 95,
        sim =  {
            {uid=0x5012, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('pid_profile') end, min = 0, max = 6},
        },            
        sport = {
    ...
    rate_profile = {
        name = bfsuite.i18n.get("telemetry.sensors.rate_profile"),
        mandatory = true,
        set_telemetry_sensors = 96,
        sim =  {
            {uid=0x5013, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('rate_profile') end, min = 0, max = 6},
        },            
        sport = {
    ...
    -- Throttle Sensors
    throttle_percent = {
        name = bfsuite.i18n.get("telemetry.sensors.throttle_pct"),
        mandatory = true,
        set_telemetry_sensors = 15,
        sim =  {
            {uid=0x5014, unit=nil, dec=0, value=function() return bfsuite.utils.simSensors('throttle_percent') end, min = 0, max = 100},
        },         
        sport = {
...
function telemetry.getSensorSource(name)
    ...
    local function checkCondition(sensorEntry)
        if not (bfsuite.session and bfsuite.session.apiVersion) then
...
function telemetry.active()
    return bfsuite.session.telemetryState or false
end
...
--[[
    ...
    Notes:
    - MSP traffic is prioritized by checking the bfsuite.app.triggers.mspBusy flag.
...
function telemetry.wakeup()
    ...
    if bfsuite.app.triggers.mspBusy then return end
    ...
    if ((now - lastCacheFlushTime) >= CACHE_FLUSH_INTERVAL) or bfsuite.session.resetTelemetry == true then
        if bfsuite.session.resetTelemetry == true then
            bfsuite.utils.log("Telemetry cache reset", "info")
            bfsuite.session.resetTelemetry = false
        end
    ...
    if not bfsuite.session.telemetryState or bfsuite.session.telemetryTypeChanged then
        telemetrySOURCE, crsfSOURCE, protocol = nil, nil, nil
        sensors = {}
    end
end
